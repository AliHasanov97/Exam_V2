<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="exam.aspx.vb" Inherits="new.az_ex.shop.exam" %>
...
<body style="width: auto">
    <form id="form1" runat="server">
        <button id="STP" type="button" style="visibility: hidden; display: none" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Static Backdrop</button>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 runat="server" class="modal-title" id="Fenn"></h5>
                                <button type="button" onclick="location.href = '/index'" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
                            </div>
                            <!-- end modal header -->
                            <div class="modal-body">
                                <asp:Label ID="Max" runat="server" Text="0"></asp:Label>
                                <h5>Sual aralığı seçin :</h5>
                                <div class="range-slider">
                                    <input type="text" class="js-range-slider" value="" />
                                </div>
                                <div class="row col-11" style="margin-top: 10px; flex-wrap: nowrap;">
                                    <input type="text" id="S_min" runat="server" class="js-input-from col-6 form-control text-center" style="margin-bottom: 10px; width: auto">
                                    <input type="text" id="S_max" runat="server" class="js-input-to col-6 form-control text-center" style="margin-bottom: 10px; width: auto">
                                </div>
                                <script>
                                ...
                                <hr />
                                <h5>Sualların düşmə üsulu :</h5>
                                <asp:DropDownList ID="DropDownList2" runat="server" CssClass="form-select">
                                    <asp:ListItem Value="0" Selected="True">Suallar təsadüfi olaraq seçilir</asp:ListItem>
                                    <asp:ListItem Value="1">Hər 10(100)sualdan bir seçilir</asp:ListItem>
                                </asp:DropDownList>
                                <h5>Sual sayı :</h5>
                                <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-select">
                                    <asp:ListItem Value="19">20</asp:ListItem>
                                    <asp:ListItem Value="29">30</asp:ListItem>
                                    <asp:ListItem Value="39">40</asp:ListItem>
                                    <asp:ListItem Selected="True" Value="49">50</asp:ListItem>
                                    <asp:ListItem Value="59">60</asp:ListItem>
                                    <asp:ListItem Value="69">70</asp:ListItem>
                                    <asp:ListItem Value="79">80</asp:ListItem>
                                    <asp:ListItem Value="89">90</asp:ListItem>
                                    <asp:ListItem Value="99">100</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                            <div class="modal-footer">
                                <button type="button" onclick="location.href = '/index'" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                <asp:Button ID="Button1" OnClientClick="Start()" CssClass="btn btn-primary" data-bs-dismiss="modal" runat="server" Text="Başla" />
                            </div>
                            <!-- end modal footer -->
                        </div>
                        <!-- end modal content-->
                ...
                <aside class="aside">
                    <nav class="navbar navbar-expand-xl navbar-vertical">
                        <div class="container-fluid">
                            ...
                            <!-- Collapse -->
                            <div class="collapse navbar-collapse" id="sidenavLargeCollapse" style="align-items: center">
                                <!-- Search -->
                                ...
                                <!--Plugin JavaScript file-->
                                <div id="panel1" class="card mb-7 card-line" style="width: fit-content; text-align: center; font-size: 20px;">
                                    <div class="card-body" style="">
                                        <!-- Heading -->
                                        <asp:Image ID="Image1" runat="server" />
                                        <hr />
                                        <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>
                                        <asp:Label ID="say" runat="server" Text="Label" Visible="False"></asp:Label>
                                        <asp:ListBox ID="ListBox1" runat="server" Visible="False"></asp:ListBox>
                                    </div>
                                </div>
                                <div id="panel2" runat="server" visible="false" class="card" style="width: fit-content; text-align: center; font-size: 20px;">
                                    <div class="card-body" style="">
                                        <!-- Heading -->
                                        <asp:Button ID="Button2" CssClass="btn btn-secondary" runat="server" Text="Təsdiqlə" />
                                    </div>
                                </div>
