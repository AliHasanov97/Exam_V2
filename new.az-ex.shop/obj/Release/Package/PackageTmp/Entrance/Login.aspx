<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Login.aspx.vb" Inherits="new.az_ex.shop.Login" %>
            ...
            <div class="col-12" style="max-width: 25rem">
                ...
                <form id="form1" runat="server" class="mb-5">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <div id="First" runat="server" class="mb-4">
                                <p id="MSG" runat="server" class="lead text-center text-body-secondary">Access our dashboard and start tracking your tasks.</p>
                                <label class="visually-hidden" for="email">Email Address</label>
                                <asp:TextBox ID="Email" CssClass="form-control text-center" runat="server"></asp:TextBox>
                            </div>
                            <div id="Second" runat="server" style="text-align: -webkit-center;" class="mb-4">
                                <p>
                                    <img id="Avatar" runat="server" class="avatar avatar-xl avatar-status avatar-status-success me-3" src="./assets/img/photos/photo-6.jpg" alt="..." />
                                    <span id="Name1" runat="server" style="text-align: center; font-family: 'times New Roman', Times, serif; font-size: 23px">Azdsd</span>
                                </p>
                                <label class="visually-hidden" for="email">Email Address</label>
                                <p id="MSG1" runat="server" visible="false" class="lead text-center text-body-secondary">Access our dashboard and start tracking your tasks.</p>
                                <asp:TextBox ID="Password" CssClass="form-control text-center" runat="server"></asp:TextBox>
                            </div>
                            <asp:Button ID="Button1" CssClass="btn btn-secondary w-100" runat="server" Text="Daxil ol" />
